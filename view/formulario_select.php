...
<body>
	...
	<div id="mySite">
		...
		<div>
			<button disabled type="button" style="background-color: red;border-radius: 10px;float: right;">
		...
		<form method="POST" id="formulario" action="<?php echo filter_input(INPUT_SERVER, "PHP_SELF"); ?>"
			...
			<input type="hidden" name="method" value="selectProduct">
			...
			<input type="submit" value="Buscar Produto" name="alterar" style="border-radius: 10px;background-color: red;color: white;font-family: 'Bebas Neue', Arial;font-size: 35px;width: 316px;height: 43px;float: right;margin-top: 50px;margin-right: 50px;">
