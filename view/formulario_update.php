...
<body>
	...
	<div id="mySite">
		...
		<button disabled id="update" class= "submit" type="button">
		...
		<form method="POST" id="formulario" action="<?php echo filter_input(INPUT_SERVER, "PHP_SELF"); ?>"
			...
			<input type="hidden" name="method" value="searchProduto">
			...
			<input type="submit" value="Alterar Produto" name="alterar" style="border-radius: 10px;background-color: red;color: white;font-family: 'Bebas Neue', Arial;font-size: 35px;width: 316px;height: 43px;float: right;margin-top: 50px;margin-right: 50px;">
